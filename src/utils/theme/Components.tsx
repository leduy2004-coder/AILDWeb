...
const components = (theme: Theme) => {
  return {
      ...
      styleOverrides: {
        root: {
          ...
          '&.Mui-error:hover .MuiOutlinedInput-notchedOutline': {
            borderColor: '#fb977d',
            backgroundColor: 'rgb(254,243,244)',
          },
      ...
      styleOverrides: {
        root: {
          ...
          '& .MuiInputBase-root.MuiOutlinedInput-root.Mui-error': {
            ...
            '& .MuiInputBase-input.MuiOutlinedInput-input, & .MuiButtonBase-root.MuiIconButton-root':
            {
    ...
    MuiSelect: {
      styleOverrides: {
        select: {
          '&.MuiSelect-outlined.Mui-error.MuiInputBase-input.MuiOutlinedInput-input':
          {
            WebkitTextFillColor: '#ff0000',
            zIndex: 1,
            '&hover': {
